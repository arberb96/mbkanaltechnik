    ...
    <section id='contact'>
      ...
      <div className="contact__left">
          ...
          <article className='contact__option'>
              <FaPhone size={16}/>
              <h5>Telefon</h5>
              <a className="contact-link" href="tel:+41792104040" target='_blank' data-rel="external" rel="noreferrer">079-210-40-40</a>
            </article>
            <article className='contact__option'>
              <FaFax size={16}/>
              <h5>Fix</h5>
              <a className="contact-link" href="tel:+41448400025" target='_blank' data-rel="external" rel="noreferrer">044-840-00-25</a>
            </article>
            <article className='contact__option'>
              <FaWhatsapp size={16}/>
              <h5>WhatsApp</h5>
              <a className="contact-link" href="https://api.whatsapp.com/send?phone=+41792104040" target='_blank' rel="noreferrer">079-210-40-40</a>
            </article>
          </div>
