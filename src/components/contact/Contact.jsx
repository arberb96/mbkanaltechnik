      ...
      <div className="contact__left">
          ...
          <article className='contact__option'>
            ...
            <article className='contact__option'>
              <FaWhatsapp size={16}/>
              <h5>WhatsApp</h5>
              <a className="contact-link" href="https://api.whatsapp.com/send?phone=+448400025" target='_blank' rel="noreferrer">044-840-00-25</a>
            </article>
          </div>
          <div className="contact__address-map">
            <p className="contact__address">Leimbachstrasse 153, Zürich, Switzerland</p>
